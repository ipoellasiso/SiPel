            ...
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="col-md-1">
                            <div class="btn-group dropdown me-1 mb-1">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuOffset">
                                    ...
                                    <a class="dropdown-item" href="/datarealisasiadmin/export" data-toggle="tooltip" data-placement="top" title="klik"> Download Data </a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="m-t-25 table-responsive">
                        <table id="data-table" class="tabelrealisasiadmin table table-hover" style="width:100%">
                            <thead>
                                <tr>
...
@include('Penatausahaan.Penerimaan.Realisasi_Admin.Fungsi.Fungsi')
